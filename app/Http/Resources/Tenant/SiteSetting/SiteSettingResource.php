...
class SiteSettingResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'recaptcha_secret_key_configured' => filled($this->recaptcha_secret_key),
            ...
            'mail_fallback_host' => $this->mail_fallback_host,
            'mail_fallback_port' => $this->mail_fallback_port,
            'mail_fallback_user_name' => $this->mail_fallback_user_name,
            'mail_fallback_password_configured' => filled($this->mail_fallback_password),
            'mail_fallback_encryption' => $this->mail_fallback_encryption,
            'storage_url' => $this->storage_url,
            'storage_type' => $this->storage_type,
            'storage_access_key_configured' => filled($this->storage_access_key),
            'storage_secret_key_configured' => filled($this->storage_secret_key),
