...
namespace App\Http\Controllers\Tenant\PurchaseOrder;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Http\Requests\Tenant\PurchaseOrder\PurchaseOrderRequest;
use App\Services\Tenant\PurchaseOrder\PurchaseOrderService;
