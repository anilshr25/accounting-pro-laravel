...
<body style="margin:0; padding:0; background:#f4f6f9; font-family: Arial, sans-serif;">
    ...
    <div
        style="max-width:600px; margin:30px auto; background:#ffffff; border-radius:10px; overflow:hidden; border:1px solid #eaeaea;">
        ...
        <div style="padding:25px; color:#333333;">
            ...
            <div
                style="margin-top:20px; padding:15px; background:#fff3cd; border-left:5px solid #ffc107; border-radius:5px;">
